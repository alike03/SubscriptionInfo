...
<nav
	class="tabs-shell relative grid gap-1 rounded-xl border border-white/8 bg-card/70 p-1 shadow-[0_16px_42px_-30px_rgba(0,0,0,0.9)] backdrop-blur"
...
>
	...
	{#each tabs as tab}
		<button
			class={`relative z-10 min-w-0 cursor-pointer rounded-lg border border-transparent px-2.5 py-2 text-xs font-semibold transition-colors duration-200 ease-out ${
				activeTab === tab.id
					? 'text-main'
...
<style>
	...
	.tabs-active {
		...
		border: 1px solid rgb(161 205 68 / 0.35);
		border-radius: 0.5rem;
		background: rgb(161 205 68 / 0.15);
		box-shadow: 0 12px 24px -18px rgb(161 205 68 / 0.9);
